...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Felix Huang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'M.S. in ECE at University of Washington', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yijiehuang-blog.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, Software Engineering, Leetcode, Computer Science, Backend Development', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，I\'m a ECE master student at University of Washington. Welcome to my blog!',
